% Simulation of a linear quadruple tank lab process controlled by
% an MPC controller using MPCSim.
%
...
s = [zeros(60/h,1); 3*ones(1400/h,1)];
s = [s zeros(length(s),1)];

% Input disturbance trajectory
d = [zeros(600/h,1); -1*ones(860/h,1)];
